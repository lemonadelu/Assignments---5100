	  ...
	  private ArrayList<Student> students = new ArrayList<Student>(10);
		...
		public boolean isFull() {
			...
			if(c.students.size() < 10) {
			  System.out.print("Course "+c.getName()+" is not full");
				return false;
			}
			else {
		...
		public void accessor() {
			Course c = new Course(name, numberOfStudent);			
			System.out.println("The number of students registered "+c.getName()+" is "+c.getStudents().size());
		}
